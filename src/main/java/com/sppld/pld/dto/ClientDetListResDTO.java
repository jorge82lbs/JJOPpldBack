...
@NoArgsConstructor
@AllArgsConstructor
public class ClientDetListResDTO {
	
	@JsonProperty("id") 
    private Integer liId;
	
	@JsonProperty("idClientDet")
	private Integer liIdClientDet;
	...
	public Integer getLiIdClientDet() {
		return liIdClientDet;
	}

	public void setLiIdClientDet(Integer liIdClientDet) {
		this.liIdClientDet = liIdClientDet;
	}
